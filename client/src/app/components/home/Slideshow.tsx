...
import "../../../assets/app/css/slideshow.css"; 
  ...
  return (
    <section className="slideshow">
      <Swiper
        ...
        effect="fade"
        loop={true}
        fadeEffect={{ crossFade: true }} // ✅ Fix overlap issue
          ...
          <SwiperSlide key={slide.id} className="swiper-slide">
            <div className="slide-content d-flex flex-row-reverse align-items-center justify-content-between">
              <div className="slideshow-image-container">
                <img src={slide.imgSrc} alt={slide.subtitle} className="slideshow-image img-fluid" />
              </div>
